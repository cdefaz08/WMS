...
from schemas.LocationMaintance.LocationType import LocationTypeCreate , LocationTypeUpdate
from crud.LocationMaintance.LocationTypes import create_location_type , get_all_location_types , update_location_type , delete_location_type, get_location_type_by_id
