"""Updated Receip Lines model

Revision ID: 4e9d92354ae0
Revises: 95eba1de0443
Create Date: 2025-04-17 12:07:56.911634
...
revision: str = '4e9d92354ae0'
down_revision: Union[str, None] = '95eba1de0443'
...
def upgrade():
    ...
    op.create_table(
        ...
        sa.Column('item_id', sa.String(50), sa.ForeignKey('items.id'), nullable=False),
...
def downgrade():
    op.drop_table('receipt_lines')  # en downgrade solo la borramos